...
if __name__ == '__main__':
    ...
    print('n_actions', hyper_params['n_actions'])
    ...
    for t in range(hyper_params["num-steps"]):
        ...
        if sample > eps_threshold:
            ...
            if args.retrieval:
                ...
                print(f'Shape of o/p of 1 forward_module: {fwd_states[0].shape}')
                fwd_states = [dream.reshape((-1,)+dream.shape[2:]) for dream in fwd_states]
                print(f'New shape: {fwd_states[0].shape}')
                ...
                print(f'Shape of fwd_states: {fwd_states.shape}')
